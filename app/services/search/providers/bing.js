...
exports.fetch = function (
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (
            (resultsPerPage !== 12 && vertical === "images") ||
            (resultsPerPage !== 10 && vertical === "web") ||
            (resultsPerPage !== 12 && vertical === "videos") ||
            (resultsPerPage !== 10 && vertical === "news")
        ) {
            throw {
                name: "Bad Request",
                message:
                    "Invalid number of results per page (Bing only supports a fixed number of results per page, and can therefore not support Distribution of Labour)",
            };
        }
        if (
            ...
            throw {
                name: "Bad Request",
                message:
                    "The Bing search provider does not support relevance feedback, but got relevance feedback documents.",
            };
        }
        ...
        if (vertical === "web") BingApi.web(query, options, callback);
            ...
            BingApi.images(query, options, callback);
